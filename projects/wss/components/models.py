...
class Scheme(models.Model):
    ...
    list_tanks = models.ManyToManyField(Tank, blank=True, related_name="sch_tanks")
    list_treatments = models.ManyToManyField(TreatmentProcess, blank=True, related_name="sch_tps")
